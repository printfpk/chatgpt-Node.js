...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/chat`, {
      title
    }, {
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_BASE_URL}/api/chat`, { withCredentials: true })
      .then(response => {
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`${import.meta.env.VITE_BASE_URL}/api/chat/messages/${chatId}`, { withCredentials: true })
